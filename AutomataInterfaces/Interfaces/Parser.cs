...
namespace AutomataInterfaces.Interfaces
{
    ...
    public partial class Parser 
    {
        ...
        private void ParseStart(ParseNode parent)
        {
            ...
            tok = scanner.LookAhead(TokenType.GRAMMARCOMMENTLINE, TokenType.GRAMMARCOMMENTBLOCK, TokenType.ATTRIBUTEOPEN, TokenType.GRAMMARSTRING, TokenType.GRAMMARARROW, TokenType.GRAMMARNONKEYWORD, TokenType.GRAMMARKEYWORD, TokenType.GRAMMARSYMBOL, TokenType.INTERFACE_KEYWORD, TokenType.INTERFACE_TYPES, TokenType.CODEBLOCKOPEN, TokenType.DIRECTIVEOPEN);
            while (tok.Type == TokenType.GRAMMARCOMMENTLINE
                ...
                || tok.Type == TokenType.INTERFACE_KEYWORD
                || tok.Type == TokenType.INTERFACE_TYPES
                ...
                || tok.Type == TokenType.DIRECTIVEOPEN)
            {
                ...
                switch (tok.Type)
                {
                    ...
                    case TokenType.INTERFACE_TYPES:
        ...
        private void ParseGrammarBlock(ParseNode parent)
        {
            ...
            do {
                tok = scanner.LookAhead(TokenType.GRAMMARSTRING, TokenType.GRAMMARARROW, TokenType.GRAMMARNONKEYWORD, TokenType.GRAMMARKEYWORD, TokenType.GRAMMARSYMBOL, TokenType.INTERFACE_KEYWORD, TokenType.INTERFACE_TYPES);
                switch (tok.Type)
                {
                    case TokenType.GRAMMARSTRING:
                    ...
                    case TokenType.GRAMMARSYMBOL:
                        ...
                        break;
                    case TokenType.INTERFACE_KEYWORD:
                        tok = scanner.Scan(TokenType.INTERFACE_KEYWORD);
                        n = node.CreateNode(tok, tok.ToString() );
                        node.Token.UpdateRange(tok);
                        node.Nodes.Add(n);
                        if (tok.Type != TokenType.INTERFACE_KEYWORD) {
                            tree.Errors.Add(new ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.INTERFACE_KEYWORD.ToString(), 0x1001, 0, tok.StartPos, tok.StartPos, tok.Length));
                            return;
                        }
                        break;
                    case TokenType.INTERFACE_TYPES:
                        tok = scanner.Scan(TokenType.INTERFACE_TYPES);
                        n = node.CreateNode(tok, tok.ToString() );
                        node.Token.UpdateRange(tok);
                        node.Nodes.Add(n);
                        if (tok.Type != TokenType.INTERFACE_TYPES) {
                            tree.Errors.Add(new ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.INTERFACE_TYPES.ToString(), 0x1001, 0, tok.StartPos, tok.StartPos, tok.Length));
                            return;
                        }
                        break;
                    default:
        ...
        private void ParseCodeBlock(ParseNode parent)
        {
            ...
            tok = scanner.LookAhead(TokenType.DOTNET_COMMENTLINE, TokenType.DOTNET_COMMENTBLOCK, TokenType.DOTNET_TYPES, TokenType.DOTNET_KEYWORD, TokenType.INTERFACE_TYPES, TokenType.INTERFACE_KEYWORD, TokenType.DOTNET_SYMBOL, TokenType.DOTNET_STRING, TokenType.DOTNET_NONKEYWORD);
