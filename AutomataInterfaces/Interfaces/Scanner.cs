...
namespace AutomataInterfaces.Interfaces
{
    ...
    public partial class Scanner
    {
        ...
        public Scanner()
        {
            ...
            //Dinh nghia cac tu khoa
            regex = new Regex(@"^(Def:|Var:|Location:|Input:|Output:|q0:|Transition:|false|true|not|and|or)", RegexOptions.Compiled);
            Patterns.Add(TokenType.INTERFACE_KEYWORD, regex);
            Tokens.Add(TokenType.INTERFACE_KEYWORD);
            
            //DInh nghia cac kieu
            regex = new Regex(@"^(Array|Bool|Byte|Real|Enum|Int|BitVec|Set)", RegexOptions.Compiled);
            Patterns.Add(TokenType.INTERFACE_TYPES, regex);
            Tokens.Add(TokenType.INTERFACE_TYPES);
    ...
    public enum TokenType
    {
            ...
            VB_NONKEYWORD= 37,
            VB_STRING= 38,
            DOTNET_COMMENTLINE= 39,
            DOTNET_COMMENTBLOCK= 40,
            DOTNET_SYMBOL= 41,
            DOTNET_NONKEYWORD= 42,
            DOTNET_STRING= 43,
            CODEBLOCKOPEN= 44,
            CODEBLOCKCLOSE= 45,
            GRAMMARKEYWORD= 46,
